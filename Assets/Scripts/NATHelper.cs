...
/**
 * Modified from https://github.com/noblewhale/NATPunchthroughClient/blob/master/Assets/NATHelper.cs
 *
...
public class NATHelper : MonoBehaviour
{
    ...
    // public string facilitatorIP = "192.168.56.1"; 
    public string facilitatorIP = "www.grabblesgame.com"; 
            ...
            if (packet != null)
            {
                ...
                switch (messageType)
                {
                    case DefaultMessageIDTypes.ID_NAT_PUNCHTHROUGH_SUCCEEDED:
                        ...
                        serverAddress = packet.systemAddress.ToString(false);
                        rakPeer.Connect(packet.systemAddress.ToString(false), natConnectPort, "", 0);
                        Debug.Log("Hole punched! " + serverAddress + ":" + natConnectPort);
                        break;
                    ...
                    case DefaultMessageIDTypes.ID_CONNECTION_REQUEST_ACCEPTED:
                        ...
                        Debug.Log("Hole punched! We are using port : " + natListenPort);
                        Debug.Log("Connected");
                    ...
                    case DefaultMessageIDTypes.ID_DISCONNECTION_NOTIFICATION:
                        ...
                        // Hole is punched!
                        onHolePunched(natListenPort, natConnectPort, serverAddress);
